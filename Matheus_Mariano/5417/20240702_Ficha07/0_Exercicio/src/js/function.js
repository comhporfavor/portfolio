...
$(document).ready(function(){
  if ( whereAmI == "/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/registar-cinemas.html"
    || whereAmI == "/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/editar-cinemas.html"
  ){
    selectLocal();
  }
  ...
  if ( whereAmI == "/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/registar-cinemas.html"
    || whereAmI == "/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/editar-cinemas.html"
    || whereAmI == "/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/registar-salas.html"
    || whereAmI == "/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/editar-salas.html"
    || whereAmI == "/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/registar-sessoes.html"
    || whereAmI == "/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/editar-sessoes.html"
  ) {
    getCinemas();
  }

  if (whereAmI == "/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/editar-salas.html"){
    getSalas();
  }

  if(whereAmI=="/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/listar-cinemas.html"){
  listarCinemas();
  }
  
  if(whereAmI=="/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/listar-salas.html"){
  listarSalas();
  }

  if( whereAmI=="/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/registar-filmes.html"
    || whereAmI=="/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/editar-filmes.html"
    || whereAmI=="/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/registar-sessoes.html"
  ) {
    getTipos();
    getFilmes();
  ...
  if (whereAmI=="/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/listar-filmes.html"){
    listarFilmes();
  }

  if (whereAmI == "/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/editar-sessoes.html"){
    getSessoes();
    getSalas();
    getFilmes();
  }

  if (whereAmI=="/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/listar-sessoes.html"){
    listarSessoes();
  }

  if (whereAmI == "/Matheus_Mariano/5417/20240702_Ficha07/0_Exercicio/index.html"){
    countFilmes();
    countCinemas();
    listarSessoes();
  }
